# Integration of secrets in Vault with AMA migration bundle
...
## Step 6: Modify the migration artifacts generated by  Application Modernization Accelerator server

1. Download the migration bundle from Application Modernization Accelerator for your application,  and unzip it.
...
For detail instructions you can check [here](https://www.ibm.com/docs/en/ama?topic=migration-how-deploy-your-app-red-hat-openshift-container-platform)
