# Deploy a Simple application to Kubernetes
 ...
 - The full instructions for creating an image and then deploying to OpenShift can be found [here](https://www.ibm.com/docs/en/ama?topic=migration-how-deploy-your-app-red-hat-openshift-container-platform)
 - However, you may not be deploying to OpenShift using Operators
 - In that case Application Modernization Accelerator still provides accelerators to assist with deployment to Kubernetes
